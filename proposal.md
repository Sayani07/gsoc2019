...
| Phase 2 	| Coding Period 1                  	| 3 Weeks (27 May - 16 June)       	| Create functions for module BUILD and COMPATIBLE. Conduct unit tests to check robustness of functions and include documentation for module BUILD. Use example data sets (created in Pre-GSoc period) to demonstrate the utility of each of the functions in that module.                                                                                                                                                                                                                                                                                                        	|
...
| Phase 4 	| Coding Period 2                  	| 1.5 Weeks (29 June - 7 July)     	| Conduct tests and work on documentation of COMPATIBLE                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           	|
|         	|                                  	| 2.5 Weeks (8 July - 22 July)     	| Develop shiny UI to guide an user to navigate through the modules of the R package.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             	|
...
| Phase 7 	| Final Week of submitting product 	| (19 August - 26 August)          	| All comments from mentors to be included in the final report stitching all the independent parts together and to be uploaded.                                                                                                                                                                                                                                                                                                                                                                                                                                                   	|
| Phase 8 	| Final evaluation                 	| (27 August - 2 September)        	| All comments from mentors to be included in the final report stitching all the independent parts together and to be uploaded.                                                                                                                                                                                                                                                                                                                                                                                                                                                   	|
