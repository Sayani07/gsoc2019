...
| Phase 3 	| Phase 1 Evaluations (24 June - 28 June)   	|              	|  Announce package base to social media community, and request input, and code review. Report on current progress at project’s wiki page after feedback from mentors.        <br><br>  Deliverables: <br><br>  1. **granularity and advice functions** <br>2. **documentation with roxygen** <br>3. **unit tests** <br>4. **example code on test data** <br>5. **CRAN tests**<br>6. **progess report**                                                                                                                                                                                                                                                                                                                                                                                                   	|
