...
During the community bonding, the main focus will be to frame a roadmap for the project with the guidance of the mentor and improving bonding with the community. The integration of various parts of the project into one another will be framed and all the development related setup will also be done during this period. The modules are independent but each module would require the output of the previous one. Hence, it is important to be able to map out the 
tasks and development plan for each of the modules at this stage.
