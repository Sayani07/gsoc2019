...
Build functions for module **BUILD** and **COMPATIBLE**. Conduct unit tests to check robustness of functions and include documentation for these two modules. Include real world example data sets to demostrate how the functions in each modules.
