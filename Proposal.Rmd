...
Since the data fed is a tsibble, it will automatically feed the available time index in the function. These functions will be able to create granularities in combination with any time index that are one or multiple level higher than the available time index in the given tsibble.
