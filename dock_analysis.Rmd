...
Also note that docks availability data is only for the month of December 2018 and count data is for entire 2018. This analysis needs to be redone using docks data for entire 2018.
